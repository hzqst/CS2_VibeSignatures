...
2. Finding `lea rdx, sub_XXXXXXX` in that function (= GameSystem_OnClientFrameSimulate).
3. Finding the virtual call offset inside GameSystem_OnClientFrameSimulate.
...
async def preprocess_skill(
    ...
    # 3. Use py_eval to find GameSystem_OnClientFrameSimulate and its vfunc offset
